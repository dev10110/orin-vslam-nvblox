...
def generate_launch_description():
    ...
    # Config file
    config_file_without_splitter = os.path.join(
        get_package_share_directory('all_launch'),
        'config', 'sensors', 'realsense.yaml')

    config_file_with_splitter = os.path.join(
        get_package_share_directory('all_launch'),
        'config', 'sensors', 'realsense_with_splitter.yaml')
    run_splitter_arg = LaunchConfiguration('run_splitter', default=True)
    ...
    load_composable_nodes_with_splitter = LoadComposableNodes(
        target_container=component_container_name_arg,
        condition=IfCondition(LaunchConfiguration('run_splitter')),
