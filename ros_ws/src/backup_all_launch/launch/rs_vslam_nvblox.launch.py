...
def generate_launch_description():
    ...
    run_splitter_arg = DeclareLaunchArgument('run_splitter', default_value='False')
    ...
    realsense_launch = IncludeLaunchDescription(
        ...
        launch_arguments={
            ...
            'run_splitter': LaunchConfiguration('run_splitter')}.items(),
    ...
    vslam_launch = IncludeLaunchDescription(
        ...
        # condition=( IfCondition(LaunchConfiguration('run_vslam')) and UnlessCondition(LaunchConfiguration('run_splitter')))
    )
    # Nvblox
